...
import org.jiezhou.annotation.DBRouter;
...
public class DBRouterJoinPoint {
    private Logger logger = LoggerFactory.getLogger(DBRouterJoinPoint.class.getName());
    ...
    @Pointcut("@annotation(org.jiezhou.annotation.DBRouter)")
